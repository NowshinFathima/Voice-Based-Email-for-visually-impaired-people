...
email_password = 'sdmz bzlj rrtu byle'
s.starttls()
...
def compose_view(request):
    ...
    if request.method == 'POST':
        ...
        flag = True
        flag1 = True
        fromaddr = "finalprojectcse001@gmail.com"
        toaddr = list()
        while flag1:
            while flag:
